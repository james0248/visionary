...
PRESETS = {
    "tiny": dict(
        ...
        encoder_num_heads=2,
        encoder_num_kv_heads=1,
        encoder_model_dim=64,
        encoder_mlp_hidden_dim=128,
        decoder_num_layers=4,
        decoder_num_heads=2,
        decoder_num_kv_heads=1,
        decoder_model_dim=64,
    ...
    "full": dict(
        ...
        encoder_num_kv_heads=3,
        encoder_model_dim=768,
        encoder_mlp_hidden_dim=2304,
        decoder_num_layers=8,
        decoder_num_heads=12,
        decoder_num_kv_heads=3,
        decoder_model_dim=768,
        decoder_mlp_hidden_dim=2304,
        num_latents=256,
        head_dim=64,
        channel_dim=16,
