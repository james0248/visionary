...
def build_overrides(data_dir: Path, ckpt_dir: Path, total_steps: int) -> list[str]:
    return [
        ...
        "tokenizer.encoder_num_heads=4",
        "tokenizer.decoder_num_heads=4",
        "tokenizer.encoder_num_kv_heads=2",
        "tokenizer.decoder_num_kv_heads=2",
        "tokenizer.encoder_model_dim=64",
        "tokenizer.decoder_model_dim=64",
        "tokenizer.encoder_mlp_hidden_dim=128",
        "tokenizer.decoder_mlp_hidden_dim=128",
