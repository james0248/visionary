...
class TokenizerDecoder(nn.Module):
    ...
    @nn.compact
    def __call__(self, latent: jnp.ndarray, temporal_mask: jnp.ndarray) -> jnp.ndarray:
...
class Tokenizer(nn.Module):
    ...
    def setup(self):
        ...
        self.decoder = TokenizerDecoder(**shared, patch_dim=self.patch_dim)
    ...
    def __call__(self, batch: PreprocessedVideoDataset) -> jnp.ndarray:
        ...
        return self.decoder(latent, temporal_mask)
